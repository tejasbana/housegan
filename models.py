...
def conv_block(in_channels, out_channels, k, s, p, act=None, upsample=False, spec_norm=False):
    ...
    if "leaky" in act:
        ...
        block.append(SelfAttn(out_channels))
        block.append(torch.nn.LeakyReLU(0.1, inplace=True))
    elif "relu" in act:
...
def conv_block_2(in_channels, out_channels, k, s, p, act=None, upsample=False, spec_norm=False):
    block = []
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            ...
            *conv_block_2(16, 16, 3, 1, 1, act="leaky"))
        ...
        self.decoder = nn.Sequential(
            *conv_block_2(16, 256, 3, 2, 1, act="leaky"),
            *conv_block_2(256, 128, 3, 2, 1, act="leaky"),
            *conv_block_2(128, 128, 3, 2, 1, act="leaky"))
